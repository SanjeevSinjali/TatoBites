        ...
        <div className="flex space-x-1 bg-gray-200 rounded-lg p-1 mb-8 overflow-x-auto">
          {categories.map((category) => (
            ...
            >
              ...
              <span className={`px-2 py-1 rounded-full text-xs ${activeTab === category.id
        ...
        {filteredNotifications.length === 0 ? (
          ...
          <div className="space-y-4">
            {filteredNotifications.map((notification) => (
              <div
                key={notification.id}
                className={`bg-white rounded-xl shadow-sm border-l-4 transition-all duration-200 hover:shadow-md ${!notification.read
